PROCr:N%=RND(-TIME):PROCi:S%=0:REPEAT:MODE7:VDU23;8202;0;0;0;:HIMEM=&2BFF:PROCh:S%=0:l%=1:MODE2:VDU23;8202;0;0;0;:HIMEM=&2BFF:REPEAT:PROCo:PROCA:PROCa:PROCb:PROCn:IFl%>8PROCf:PROCs:ELSEIF(l%MOD2)=1:PROCf:ELSE:PROCs
