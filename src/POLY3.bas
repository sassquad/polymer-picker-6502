PROCr:N%=RND(-TIME):PROCi:S%=0:REPEAT:MODE7:VDU23;8202;0;0;0;:HIMEM=&2C1F:PROCh:S%=0:l%=1:MODE2:VDU23;8202;0;0;0;:HIMEM=&2C1F:REPEAT:PROCo:PROCA:PROCa:PROCb:PROCn:IFl%>8PROCf:PROCs:ELSEIF(l%MOD2)=1:PROCf:ELSE:PROCs
...
UNTILFALSE:ENDPROC
DEFPROCr:IFPAGE=&E00:ENDPROC:ELSE:*T.
*FX138,0,128
*KEY0FOR@%=0TOTOP-PAGE STEP4:@%!&E00=@%!PAGE:N.|MPAGE=&E00|MOLD|MRUN|M
