...
IFSX%>D%ANDSX%>1SX%=SX%-V%:SD%=4:IFFNsbl(SX%+4)PROCu
IFSX%=D%SD%=8:IFFNsbu(SX%+8)PROCu
IFSY%<e%ANDSY%<194SY%=SY%+V%
IFSY%>e%ANDSY%>64SY%=SY%-V%
PROCd(OA%,OS%,OY%):PROCd(SD%,SX%,SY%):IFFNfb(SX%+8,SY%)PROCu
ENDPROC
...
VDU17,128,5:ENDPROC
DEFPROCe:VDU4,17,7,31,6,0:PRINTSTRING$(6-LENSTR$S%,"0");S%;:VDU5:ENDPROC
